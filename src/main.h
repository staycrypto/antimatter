...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.000000001 ANT
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00000000001 ANT mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 1000000 * COIN;
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Coinbase transaction outputs can only be spent after this number of new blocks (network rule) */
static const int COINBASE_MATURITY = 10; // 10 blocks approx 50 minutes
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 288; //576 / 250;
    }
